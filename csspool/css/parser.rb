...
module_eval(<<'...end parser.y/module_eval...', 'parser.y', 276)
...
module_eval(<<'.,.,', 'parser.y', 33)
  def _reduce_12(val, _values, result)
     result = Terms::String.new strip_string val.first 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 34)
  def _reduce_13(val, _values, result)
     result = Terms::URI.new strip_uri val.first 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 37)
  def _reduce_14(val, _values, result)
     result = [val.first, Terms::Ident.new(val.last)] 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 38)
  def _reduce_15(val, _values, result)
     result = Terms::Ident.new val.first 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 66)
  def _reduce_26(val, _values, result)
     @document.start_selector Array(val.first) 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 106)
  def _reduce_37(val, _values, result)
     result = Selectors::Type.new val.first, nil 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 107)
  def _reduce_38(val, _values, result)
     result = Selectors::Universal.new val.first, nil 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 120)
  def _reduce_47(val, _values, result)
     result = Selectors::Id.new val.first.sub(/^#/, '') 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 122)
  def _reduce_48(val, _values, result)
     result = Selectors::Class.new val.last 
    result
  end
.,.,
...
module_eval(<<'.,.,', 'parser.y', 164)
  def _reduce_56(val, _values, result)
     result = Selectors::PseudoClass.new val[1], nil 
    result
  end
.,.,
